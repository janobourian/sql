...
1. [Use The Index, Luke: Grouping and Aggregation Performance](https://use-the-index-luke.com/sql/sorting-grouping/group-by)
2. [Modern SQL: PostgreSQL GROUPING SETS, ROLLUP and CUBE Guide](https://modern-sql.com/feature/grouping-sets)
3. [Brandur Leach: High-Performance Aggregations with Postgres JSONB](https://brandur.org/postgres-json)
4. [Craig Kerstiens: Deep Dive into PostgreSQL Aggregations and Window Functions](https://www.craigkerstiens.com/)
5. [High-Performance PostgreSQL: Parallel Aggregation in High-Throughput Reporting](https://www.cybertec-postgresql.com/en/parallel-aggregation-in-postgresql/)
