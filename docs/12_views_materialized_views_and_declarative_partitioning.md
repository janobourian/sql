...
1. [Brandur Leach: Postgres Partitioning in Practice and Zero-Downtime Data Detach](https://brandur.org/postgres-partitioning)
2. [Use The Index, Luke: Table Partitioning and Index Pruning](https://use-the-index-luke.com/)
3. [Craig Kerstiens: PostgreSQL Partitioning: Declarative vs Inheritance](https://www.craigkerstiens.com/)
4. [High-Performance PostgreSQL: Zero-Downtime Archival with DETACH CONCURRENTLY](https://www.cybertec-postgresql.com/en/detach-partition-concurrently-in-postgresql-14/)
5. [Database Trends & Applications: Scaling Multi-Terabyte RDBMS with Table Partitioning](https://www.dbta.com/)
