...
6. [Use The Index, Luke: Join Algorithms (Nested Loop, Hash, Merge)](https://use-the-index-luke.com/sql/sorting-grouping/join-operations)
7. [Brandur Leach: Postgres Query Planner and Join Optimization](https://brandur.org/postgres-plan)
8. [Martin Kleppmann: Joins in Distributed and Relational Databases](https://dataintensive.net/)
9. [Craig Kerstiens: Joins in PostgreSQL: Inner, Outer, and Lateral](https://www.craigkerstiens.com/)
10. [High-Performance PostgreSQL: Tuning work_mem for Fast Hash Joins](https://www.cybertec-postgresql.com/en/tuning-work_mem-in-postgresql/)
