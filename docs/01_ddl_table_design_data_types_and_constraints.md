...
1. [Use The Index, Luke: Foreign Keys and Missing Indexes](https://use-the-index-luke.com/sql/where-clause/searching-for-ranges/foreign-keys)
2. [Brandur Leach: Identity Columns vs UUIDs in Modern PostgreSQL](https://brandur.org/postgres-keys)
3. [Martin Kleppmann: Data Modeling and Normalization Trade-Offs](https://dataintensive.net/)
4. [Craig Kerstiens: PostgreSQL Schema Design Mistakes to Avoid](https://www.craigkerstiens.com/)
5. [Baeldung on Computer Science: Database Normalization (1NF to 5NF)](https://www.baeldung.com/cs/database-normalization)
