...
1. [Brandur Leach: Postgres Transactions, Isolation Levels, and MVCC](https://brandur.org/postgres-isolation)
2. [Use The Index, Luke: Concurrency, Locking and Isolation](https://use-the-index-luke.com/)
3. [Martin Kleppmann: Transactions and Multi-Version Concurrency Control](https://dataintensive.net/)
4. [Craig Kerstiens: Understanding PostgreSQL Locking and Concurrency](https://www.craigkerstiens.com/)
5. [High-Performance PostgreSQL: Eliminating Deadlocks and Lock Contention](https://www.cybertec-postgresql.com/en/postgresql-deadlocks/)
