...
1. [Use The Index, Luke: The B-Tree Index Deep Dive](https://use-the-index-luke.com/sql/anatomy)
2. [Brandur Leach: Postgres Indexing Strategies and GIN / BRIN Performance](https://brandur.org/postgres-indexes)
3. [Craig Kerstiens: PostgreSQL Covering Indexes and Index-Only Scans](https://www.craigkerstiens.com/)
4. [High-Performance PostgreSQL: BRIN Indexes for Billion-Row Time-Series](https://www.cybertec-postgresql.com/en/what-is-a-brin-index-in-postgresql-and-how-to-use-it-efficiently/)
5. [Database Trends & Applications: Modern Relational Indexing Benchmarks](https://www.dbta.com/)
