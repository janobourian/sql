...
6. [Use The Index, Luke: Execution Plans, Cost Models, and Optimizer Bottlenecks](https://use-the-index-luke.com/sql/explain-plan)
7. [Brandur Leach: Reading Postgres EXPLAIN Plans and Buffer Metrics](https://brandur.org/postgres-plan)
8. [Craig Kerstiens: Demystifying PostgreSQL EXPLAIN ANALYZE](https://www.craigkerstiens.com/)
9. [High-Performance PostgreSQL: Extended Statistics and Multi-Column Correlation](https://www.cybertec-postgresql.com/en/extended-statistics-in-postgresql/)
10. [Database Trends & Applications: Modern Query Optimization Patterns](https://www.dbta.com/)
