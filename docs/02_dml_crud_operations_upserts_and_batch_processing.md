...
1. [Use The Index, Luke: High-Performance Batch Insert and Upsert Strategies](https://use-the-index-luke.com/)
2. [Brandur Leach: Postgres Batching, COPY vs INSERT, and Lock Contention](https://brandur.org/postgres-batch-copy)
3. [Martin Kleppmann: Transactions and Write Paths in Relational Systems](https://dataintensive.net/)
4. [Craig Kerstiens: Understanding PostgreSQL HOT (Heap-Only Tuples) Updates](https://www.craigkerstiens.com/)
5. [High-Performance PostgreSQL: Eliminating Deadlocks in High-Throughput DML](https://www.cybertec-postgresql.com/en/postgresql-deadlocks/)
